...
Na prática, estou aplicando esses conceitos no **Hackathon Oracle One**, liderando o desenvolvimento de um projeto de **Análise de Sentimento**.
...
### 🛠️ Especializações Técnicas

* **Engenharia de Dados & ETL:** Desenvolvimento de *pipelines* de dados e scripts de automação utilizando **Python (Pandas, NumPy)**. Experiência na extração, limpeza e carregamento de dados.
* **Business Intelligence:** Criação de dashboards interativos e relatórios gerenciais com **Power BI** e *Data Storytelling*.
* **Infraestrutura & Cloud:** Expertise na sustentação de ambientes de TI, servidores **Linux**, orquestração com **Docker** e gestão de banco de dados (SQL/NoSQL).
* **IA Generativa:** Desenvolvimento de ferramentas utilizando APIs de IA e **Prompt Engineering**.
...
## 📫 Contato
- 💼 LinkedIn: https://www.linkedin.com/in/dfarney/
- 📧 Email: f_farney@hotmail.com  

---

⭐ Perfil em constante evolução, refletindo minha transição e consolidação na área de Dados.
